    ...
    return (
      ...
      >
        ...
        >
          <motion.g
            animate={controls}
            transition={{ duration: 0.5, repeat: Infinity, repeatType: "reverse", repeatDelay: 0.6 }}
            variants={{
          ...
          <motion.path
            ...
            strokeDasharray="2 2"
            strokeWidth="1"
            transition={{ duration: 0.55, delay: 0.1, repeat: Infinity, repeatType: "reverse", repeatDelay: 0.6 }}
            variants={{
              normal: {
                pathLength: 0,
                opacity: 0,
