...
const CHECK_VARIANTS: Variants = {
  ...
  animate: {
    ...
    opacity: [0, 1],
    transition: {
      pathLength: { duration: 0.4, ease: "easeInOut", repeat: Infinity, repeatType: "reverse", repeatDelay: 1 },
      opacity: { duration: 0.4, ease: "easeInOut", repeat: Infinity, repeatType: "reverse", repeatDelay: 1 },
    },
  },
};
